...
const COPY = {
  en: {
    ...
    discoveryHead: "THE FANS YOU ALREADY HAVE MATTER. SO DO THE FANS WHO DO NOT KNOW TO SEARCH FOR YOU YET.",
  ...
  ko: {
    ...
    discoveryHead: "이미 확보한 팬도 중요하지만, 아직 검색할 이유를 모르는 팬도 중요합니다.",
  ...
  ja: {
    ...
    discoveryHead: "すでにいるファンも、まだ検索する理由を知らないファンも、同じくらい大切です。",
